...
4. If the image/PDF shows signs of tampering, editing, or forgery (blurry ref, edited amounts, inconsistent dates), set forgery_risk:true and list the specific signs in forgery_flags. forgery_risk:true must never coexist with confidence >= 0.85.
