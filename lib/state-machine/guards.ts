...
export const TRANSITION_RULES: TransitionRule[] = [
  ...
  // Letter product path can mark L1 sent without ever landing on status=escalation.
  { from: 'new', event: 'user.mark_sent', to: 'awaiting_response', guard: 'proof_and_user_approved' },
  { from: 'intake_scoping', event: 'user.mark_sent', to: 'awaiting_response', guard: 'proof_and_user_approved' },
  { from: 'monitoring', event: 'user.mark_sent', to: 'awaiting_response', guard: 'proof_and_user_approved' },
  { from: 'evidence_building', event: 'user.mark_sent', to: 'awaiting_response', guard: 'proof_and_user_approved' },
  { from: 'escalation', event: 'user.mark_sent', to: 'awaiting_response', guard: 'proof_and_user_approved' },
  { from: 'retried', event: 'user.mark_sent', to: 'awaiting_response', guard: 'proof_and_user_approved' },
