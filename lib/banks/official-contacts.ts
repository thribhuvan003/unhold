...
const BANK_CONTACTS: BankContact[] = [
  {
    ...
    contacts: [
      ...
      },
      {
        ...
        role_plain: 'General complaint inbox; submit L1 at your branch first',
        email: 'customercare@sbi.co.in',
        phone: '1800-1234',
        notes: 'Submit the L1 letter at your home branch first. Use this only as a general complaint inbox after verifying with the branch.',
        source_url: 'https://sbi.bank.in/web/customer-care/contact-us',
        verified_date: '2026-01-01',
        level: 'general',
      },
  ...
  },
  {
    ...
    contacts: [
      ...
      },
      {
        ...
        source_url: 'https://www.hdfc.bank.in/contact-us',
      ...
      },
      {
        ...
        email: 'nodal.officer@hdfc.bank.in',
  ...
  },
  {
    ...
    contacts: [
      ...
      },
      {
        ...
        email: 'nodal.officer@axis.bank.in',
        notes: 'Verify spelling and current email on the official Axis grievance page before sending.',
        source_url: 'https://www.axisbank.com/docs/default-source/default-document-library/grievance-redressal/grievance-redressal-policy.pdf',
        verified_date: '2026-07-01',
        level: 'L2',
      },
      {
  ...
  },
  {
    ...
    contacts: [
      ...
      {
        role: 'ICICI Customer Care Email',
        role_plain: 'General support inbox',
        email: 'customer.care@icici.bank.in',
        notes: 'Use as a general support route only. For formal escalation, verify the current nodal/PNO route on the official ICICI grievance page.',
        source_url: 'https://www.icici.bank.in/contact-us',
        verified_date: '2026-07-01',
        level: 'general',
      },
      {
        role: 'ICICI Principal Nodal Officer',
        role_plain: 'Final internal escalation before Ombudsman',
        email: 'pno@icicibank.com',
        notes: 'Use only after branch/customer-care escalation has not resolved the complaint. Verify on the official ICICI grievance page before sending.',
