...
export const CORPUS = [
  // ── Group A — intake classification ────────────────────────────────────────
  {
    ...
    source:
      "Product safety rule; terminology and legal effect require the underlying bank/authority record",
    source_url: "",
  ...
  },
  {
    ...
    content:
      "A fraud victim can report through the official NCRP portal or 1930. I4C manages the NCRP/CFCFRMS technical infrastructure, but its July 2026 public notice says I4C does not investigate complaints or decide to lien-mark/freeze an account. The relevant State/UT law-enforcement agency investigates, and a restriction decision may come from its investigating officer or from the bank under applicable rules. Never infer that a particular complaint caused a user's restriction; ask the bank for the written amount, authority and reference.",
    source:
      "I4C/MHA public notice (cybercrime.gov.in/UploadMedia/PublicNotice.pdf), reviewed 2026-07-14",
    source_url: "https://cybercrime.gov.in/UploadMedia/PublicNotice.pdf",
  ...
  },
  {
    ...
    source:
      "Secondary report of Bombay HC decision; primary judgment verification required",
    source_url:
  ...
  },
  {
    ...
    source:
      "Secondary report of Delhi HC decision; primary judgment verification required",
    source_url:
  ...
  },
  {
    ...
    source:
      "Secondary report of Delhi trial-court outcome; primary order verification required",
    source_url:
      "https://www.scconline.com/blog/post/2026/03/24/delhi-court-illegal-freezing-of-bank-accounts-bnss-usd-40-million-international-cyber-fraud/",
    source_type: "legal_secondary",
    confidence: "med",
    currency: "verify",
  ...
  },
  {
    ...
    source:
      "Secondary report of Allahabad HC decision; primary judgment verification required",
    source_url:
      "https://supremetoday.ai/allahabad-hc-no-prior-notice-s106-bnss-bank-freeze-20260413004",
    source_type: "legal_secondary",
    confidence: "med",
    currency: "verify",
  ...
  },
  {
    ...
    source:
      "Product safety rule; court outcomes require jurisdiction-specific legal review",
    source_url: "",
    source_type: "internal",
    confidence: "high",
    currency: "current",
  ...
  },
  {
    ...
    content:
      "MHA has publicly confirmed that an NCRP/CFCFRMS SOP was issued on 02-Jan-2026. The official Money Restoration Module now publishes a victim-restoration workflow and conditions, but that workflow must not be generalised into a universal unfreeze route for a person whose own account is restricted. Do not promise lien-only treatment, 7/15/90-day deadlines, automatic escalation/release, or a refund. Ask the bank/authority for the current written route and use MRM only when the user is an eligible fraud victim following its official instructions.",
    source:
      "MHA parliamentary reply; official MRM public FAQ; I4C/MHA public notice",
    source_url: "https://mrm-ncrp.mha.gov.in/public-info?tab=faq",
    source_type: "regulator",
    confidence: "high",
    currency: "current",
  ...
  },
  {
    ...
    source:
      "Product safety rule; prior timeline figures were not established by a public primary source",
    source_url: "",
    source_type: "internal",
    confidence: "high",
    currency: "current",
  ...
  // ── Group E — community (caveat-tagged; never a legal claim) ────────────────
  {
    ...
    source:
      "Moneylife (Apr-2023) + forums — illustrative, not current procedure",
    source_url:
      "https://www.moneylife.in/article/fraud-alert-beware-police-are-freezing-bank-accounts-for-accepting-payment-from-upi-accounts-linked-with-cybercrimes/70468.html",
  ...
  // ── Group F — official-route verification (2026) ───────────────────────────
  {
    ...
    source:
      "Live portal check; staff/login page, not verified for citizen self-service",
    source_url: "",
    source_type: "regulator",
    confidence: "high",
    currency: "current",
  ...
  },
  {
    ...
    title:
      "Which route: official fraud report, bank process, authority record, or legal help",
    content:
