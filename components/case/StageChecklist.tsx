            ...
            : stage.target === "letter"
              ...
              : stage.target === "path"
                ...
                : stage.target === "authority"
                  ...
                  : null;
        const openClass =
          "flex min-h-[44px] flex-none items-center rounded-lg border border-[var(--border-strong)] bg-[var(--surface-raised)] px-3 text-[0.78125rem] font-semibold text-[var(--color-sky-deep)] no-underline";
        return (
          <div
            key={stage.title}
            className={cn(
