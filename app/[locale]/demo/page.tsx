  ...
  return (
    <div className="mx-auto flex max-w-[430px] flex-col gap-4">
      ...
      <div className="animate-fade-up">
        ...
        <h1 className="type-display-xl mt-1.5 text-[1.625rem] leading-tight">{t('title')}</h1>
        <p className="mt-2.5 text-[0.9375rem] leading-relaxed text-[var(--ink-muted)]">{t('intro')}</p>
      ...
      {/* 2. The strongest right, sourced + honestly currency-tagged */}
      <DisproportionateFreezeCard freezeType="total_freeze" frozenAmountInr="1,800" />
      ...
      <section className="u-hero animate-fade-up px-5 py-6">
        <div className="relative z-[1]">
          <p className="type-display text-[1.25rem] text-[var(--ink)]">{t('ctaTitle')}</p>
          <p className="mt-2 text-[0.9375rem] leading-relaxed text-[var(--ink-muted)]">{t('ctaBody')}</p>
          <Link
            href="/start"
