...
const defaultDescription =
  'Indian bank account frozen after a cyber complaint or UPI credit? Unhold helps you prepare papers, a sealed proof pack, and branch/authority letters. Free, no account required — you send everything yourself. Not a law firm. Helpline 1930.';
          ...
          <footer className="border-t border-border bg-surface pt-9 pb-28 sm:py-9">
            <div className="mx-auto max-w-5xl px-4 text-center sm:px-5">
              <p className="mb-2 flex items-center justify-center gap-2 text-[0.78125rem] font-semibold">
                <Link href="/legal/disclaimer" className="text-[var(--color-sky-deep)] underline underline-offset-4 no-underline hover:underline">
                  {t('legalDisclaimer')}
                </Link>
                <span aria-hidden="true" className="text-ink-faint">·</span>
                <Link href="/legal/privacy" className="text-[var(--color-sky-deep)] underline underline-offset-4 no-underline hover:underline">
                  {t('privacyPolicy')}
                </Link>
              </p>
